...
// Fix SOAPNotesManager.tsx
const fixSOAPNotesManager = () => {
  console.log('Fixing SOAPNotesManager.tsx...');
      ...
      return (
        <div className="space-y-2">
          ...
          <textarea
            ...
            onChange={(e) => setEditedNotes({ ...editedNotes, [field]: e.target.value })}
...
export default SOAPNotesManager;`;
  ...
  fs.writeFileSync('/workspaces/symfarmia/src/components/medical/SOAPNotesManager.tsx', content, 'utf8');
  console.log('✅ Fixed SOAPNotesManager.tsx');
};

// Main function
const main = () => {
  console.log('🔧 Fixing compressed TypeScript/JSX files...\n');
