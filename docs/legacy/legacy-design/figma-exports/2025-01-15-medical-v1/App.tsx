...
const steps = [
  ...
  { id: 'flow', label: 'Revisar Flujo', icon: Stethoscope, component: DialogueFlow },
  { id: 'notes', label: 'Notas', icon: FileText, component: ClinicalNotes },
  { id: 'orders', label: 'Órdenes', icon: ClipboardList, component: OrderEntry },
  { id: 'summary', label: 'Resumen', icon: Download, component: SummaryExport },
];
    ...
    <SidebarProvider>
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-xl text-slate-900">Escriba Médica IA</h1>
              </div>
            </div>
        ...
        <div className="flex">
          ...
          {/* Contenido Principal */}
          <SidebarInset>
            <main className="p-6 transition-all duration-200">
              <CurrentComponent 
                onNext={() => {
