...
const [formData, setFormData] = useState({ name: '', email: '', phone: '', information: '', dateOfBirth: '', gender: '', status: 'Activo' });

const [errors, setErrors] = useState({});

const handleChange = (field, value) => {
   setFormData(prev => ({ ...prev, [field]: value }));
// Clear error when user starts typing if (errors[field]) { setErrors(prev => ({ ...prev, [field]: null }));
} };
