      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-purple-50 p-4 rounded-lg">
          ...
          <p className="text-2xl font-bold text-purple-900">
            {' '}
            {medicalReports.reduce(
              (acc, report) => acc + report.studies.length,
              0,
            )}{' '}
          </p>{' '}
        </div>{' '}
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="text-sm text-gray-500 ">
                          {' '}
                          {calculateAge(report.patient.dateOfBirth)} años •{' '}
          ...
          <div className="flex justify-between items-start">
            ...
            <div>
              ...
              <h3 className="text-xl font-semibold text-gray-900 ">
                Reporte Médico #{selectedReport.id}
              </h3>{' '}
              <p className="text-sm text-gray-600 mt-1">
                {' '}
                Fecha: {formatDate(selectedReport.date)} • Vence:{' '}
                {formatDate(selectedReport.expirationDate)}{' '}
              </p>{' '}
            </div>{' '}
            <span
              className={`px-3 py-1 text-sm font-semibold rounded-full ${getStatusColor(selectedReport.status)}`}
            >
              {' '}
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="flex items-center mb-3">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-gray-600 ">
                      {' '}
                      {calculateAge(selectedReport.patient.dateOfBirth)} años •{' '}
                ...
                <div className="grid grid-cols-1 gap-2 text-sm">
                  ...
                  <div>
                    ...
                    <span className="ml-2 text-gray-600 ">
                      {formatDate(selectedReport.patient.dateOfBirth)}
                    </span>{' '}
                  </div>{' '}
                </div>{' '}
              </div>{' '}
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <div className="flex items-center gap-2">
                      {' '}
                      <span
                        className={`px-2 py-1 text-xs font-semibold rounded-full ${getStudyStatusColor(study.status)}`}
                      >
                        {' '}
                        {study.status}{' '}
                      </span>{' '}
