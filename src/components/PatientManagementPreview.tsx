      ...
      <div className="bg-white rounded-lg max-w-6xl w-full max-h-[90vh] overflow-hidden">
                    ...
                    {patients.map(patient => (
                      <tr key={patient.id} className="hover:bg-gray-50 ">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <div className="flex gap-2">
                            <button className="text-blue-600 hover:text-blue-900 transition-colors">{t('view')}</button>
                            <button className="text-indigo-600 hover:text-indigo-900 transition-colors">{t('edit')}</button>
                            <button className="text-red-600 hover:text-red-900 transition-colors">{t('delete')}</button>
                          </div>
                        </td>
                      </tr>
                    ))}
        ...
        <div className="p-6 border-t border-gray-200 bg-gray-50 ">
          <div className="flex justify-between items-center">
            <div className="text-sm text-gray-600 ">{t('preview_footer')}</div>
            <button
              onClick={onClose}
