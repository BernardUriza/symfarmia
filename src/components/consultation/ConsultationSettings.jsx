      ...
      >
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white">
                {t('consultation_settings') || 'Configuración de Consulta'}
              </h2>
              <p className="text-sm text-gray-600 dark:text-gray-300">
                {t('customize_experience') || 'Personaliza tu experiencia médica'}
              </p>
            </div>
          </div>
          <button
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex-1 flex items-center justify-center space-x-2 px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 ${
                    activeTab === tab.id
        ...
        <div className="flex items-center justify-between p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
          <div className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <span>Preset activo: {settings.activePreset || 'Personalizado'}</span>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              {t('save_settings') || 'Guardar Configuración'}
            </button>
          </div>
        </div>
      </motion.div>
