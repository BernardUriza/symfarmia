...
const colors = { blue: 'bg-blue-600 hover:bg-blue-700', red: 'bg-red-600 hover:bg-red-700', indigo: 'bg-indigo-600 hover:bg-indigo-700', gray: 'bg-gray-600 hover:bg-gray-700' };
return colors[color] || colors.blue;
};
