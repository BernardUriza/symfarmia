...
const AISettings = ({ settings, onSettingChange }) => {
  ...
  const aiAssistanceLevels = [
    {
      ...
      features: ['Transcripción en tiempo real', 'Notas simples', 'Detección de palabras clave'],
      icon: '📝',
      color: 'gray'
    },
    {
      ...
      features: ['Todo lo básico', 'Sugerencias de diagnóstico', 'Alertas básicas', 'SOAP automático'],
      icon: '🤖',
      color: 'blue',
      recommended: true
    },
    {
      ...
      features: ['Todo lo intermedio', 'Análisis profundo', 'Alertas críticas', 'Sugerencias de tratamiento'],
      icon: '🧠',
      color: 'purple'
    }
  ];
  ...
  const notesFormats = [
    {
      ...
      icon: '📋',
      example: 'S: Paciente refiere dolor\nO: TA 120/80\nA: HTA leve\nP: Seguimiento'
    },
    {
      id: 'narrative',
      ...
      icon: '📄',
      example: 'El paciente acude por dolor de cabeza que inició hace 2 días...'
    },
    {
      id: 'hybrid',
  ...
  const getColorClasses = (color, isSelected) => {
    const colors = {
      ...
      pink: isSelected ? 'border-pink-500 bg-pink-50 dark:bg-pink-900/20' : 'border-gray-200 dark:border-gray-700 hover:border-pink-300',
      orange: isSelected ? 'border-orange-500 bg-orange-50 dark:bg-orange-900/20' : 'border-gray-200 dark:border-gray-700 hover:border-orange-300',
      ...
      purple: isSelected ? 'border-purple-500 bg-purple-50 dark:bg-purple-900/20' : 'border-gray-200 dark:border-gray-700 hover:border-purple-300'
    };
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-2 mb-3">
          ...
          <h4 className="font-medium text-gray-900 dark:text-white">Especialidad Médica</h4>
        </div>
          ...
          {medicalSpecialties.map((specialty) => (
            <motion.button
              ...
              className={`p-4 rounded-lg border-2 transition-all text-left ${
                getColorClasses(specialty.color, settings.medicalSpecialty === specialty.id)
              }`}
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-2 mb-3">
          ...
          <h4 className="font-medium text-gray-900 dark:text-white">Nivel de Asistencia IA</h4>
        </div>
          ...
          {aiAssistanceLevels.map((level) => (
            <motion.button
              ...
              className={`w-full p-4 rounded-lg border-2 transition-all text-left ${
                getColorClasses(level.color, settings.aiAssistanceLevel === level.id)
              }`}
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              <div className="flex items-start justify-between">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2">
                      <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">Incluye:</div>
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-2 mb-3">
          ...
          <h4 className="font-medium text-gray-900 dark:text-white">Alertas Clínicas</h4>
        </div>
          ...
          {[
            {
              ...
              description: 'Alerta ante signos de alarma (dolor torácico, disnea severa, etc.)',
              icon: '🚨',
              color: 'red'
            },
            {
            ...
            },
            {
              ...
              description: 'Señales de advertencia para derivación especializada',
              icon: '🚩',
              color: 'red'
            },
            {
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-2 mb-3">
          ...
          <h4 className="font-medium text-gray-900 dark:text-white">Formato de Notas</h4>
        </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <div className="text-sm text-blue-700 dark:text-blue-400 mt-1">
              Niveles más altos de IA pueden requerir más tiempo de procesamiento. 
              Para consultas rápidas, considera usar el nivel Intermedio.
            </div>
          </div>
        </div>
      </div>
