/** * ActionButton Usage Examples * * This file demonstrates various ways to use the ActionButton component * across different medical system scenarios. */ import React from 'react';
