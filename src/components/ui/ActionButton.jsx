...
const ActionButton = ({
  ...
  const colorConfig = {
    blue: {
      filled:
        'bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white border-blue-600 focus:ring-blue-500',
      outline:
    ...
    emerald: {
      filled:
        'bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 text-white border-emerald-600 focus:ring-emerald-500',
      outline:
    ...
    purple: {
      filled:
        'bg-purple-600 hover:bg-purple-700 active:bg-purple-800 text-white border-purple-600 focus:ring-purple-500',
      outline:
    ...
    orange: {
      filled:
        'bg-orange-600 hover:bg-orange-700 active:bg-orange-800 text-white border-orange-600 focus:ring-orange-500',
      outline:
    ...
    red: {
      filled:
        'bg-red-600 hover:bg-red-700 active:bg-red-800 text-white border-red-600 focus:ring-red-500',
    ...
    gray: {
      filled:
        'bg-gray-600 hover:bg-gray-700 active:bg-gray-800 text-white border-gray-600 focus:ring-gray-500',
      outline:
        'border-gray-600 text-gray-600 hover:bg-gray-50 active:bg-gray-100',
  ...
  const LoadingSpinner = () => (
    <div
      className={`animate-spin rounded-full border-2 border-current border-t-transparent ${currentSize.icon}`}
    >
  ...
  return (
    ...
    >
      ...
      {children || <span className={loading ? 'ml-2' : ''}>{text}</span>}
    </button>
  );
};
