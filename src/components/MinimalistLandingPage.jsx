...
const MinimalistLandingPage = ({ isDemo = false }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-primary/5 text-foreground font-sans relative overflow-hidden">
      ...
      {/* Demo Mode Banner */} {isDemoMode && <DemoModeBanner />}{" "}
      {/* Main Content */}
      <main
        className={`max-w-4xl mx-auto px-6 ${isDemoMode ? "pt-48" : "pt-32"}`}
      >
        ...
        <section className="text-center mb-20 hero-section animate-fade-in">
          <div className="card-gradient glass rounded-3xl p-12 backdrop-blur-xl border border-white/20 shadow-2xl">
            ...
            <p
              className="text-xl text-foreground/80 mb-8 max-w-2xl mx-auto leading-relaxed animate-slide-up"
            ...
            <div className="mb-8">
              ...
              <Image
                ...
                base64,iVBORw0KGgoAAAANSUhEUgAABAAAAAQACAIAAADwf7zUAAEw2mNhQlgAATDaanVtYgAAAB5qdW1kYzJwYQARABCAAACqADibcQNjMnBhAAAANxNqdW1iAAAA"
              ...
              {!isDemoMode && !isSubmitted ? (
                <div className="space-y-6">
                  ...
                  <div className="flex justify-center">
                    <button
                      onClick={handleDemoClick}
                      className="btn-medical btn-medical-secondary glass border-2 border-primary/30 text-primary hover:border-primary/50"
                    >
                      {t("demo_interactive")}
                    </button>
                  </div>
                ...
                <div className="text-center py-8 animate-fade-in">
                  ...
                  <p className="text-foreground/70">{t("check_email")}</p>
                </div>
              )}
            </div>
          </div>
        ...
        <section className="mb-20">
          <div className="grid md:grid-cols-3 gap-8">
            <div
              className="card-float glass p-8 text-center animate-slide-up"
            ...
            >
              ...
              <p className="text-gray-600 ">{t("benefit_speak_desc")}</p>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/50 text-center hover:shadow-xl transition-all duration-200 transform hover:scale-105">
              ...
              <p className="text-gray-600 ">{t("benefit_processing_desc")}</p>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/50 text-center hover:shadow-xl transition-all duration-200 transform hover:scale-105">
              ...
              <p className="text-gray-600 ">{t("benefit_report_desc")}</p>
            </div>
          </div>
        </section>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-lg border border-white/50 ">
            <div className="grid md:grid-cols-3 gap-8 items-center">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">{t("step_report_desc")}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="text-center mb-20">
          <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-lg border border-white/50 ">
            ...
            <p className="text-xl text-gray-600 mb-8">{t("final_cta_text")}</p>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 ">
              {t(
                "demo.demo_transcription_subtitle",
      ...
      <footer className="border-t border-white/30 py-8">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <p className="text-gray-600 text-sm">{t("footer_copy")}</p>
