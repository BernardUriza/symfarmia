      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg max-w-6xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-1">Vista previa de la gestión de pacientes</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          <div className="mb-6">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Lista de Pacientes</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-blue-50 dark:bg-blue-900/40 p-4 rounded-lg">
                <h4 className="text-sm font-medium text-blue-600 dark:text-blue-400">Total Pacientes</h4>
              ...
              <div className="bg-green-50 dark:bg-green-900/40 p-4 rounded-lg">
                <h4 className="text-sm font-medium text-green-600 dark:text-green-400">Pacientes Activos</h4>
                <p className="text-2xl font-bold text-green-900 dark:text-green-300">
                  {patients.filter(p => p.status === 'Activo').length}
                </p>
              </div>
              <div className="bg-red-50 dark:bg-red-900/40 p-4 rounded-lg">
                <h4 className="text-sm font-medium text-red-600 dark:text-red-400">Pacientes Inactivos</h4>
