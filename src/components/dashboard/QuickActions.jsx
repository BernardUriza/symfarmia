...
const QuickActionButton = ({
  ...
  const ButtonContent = () => (
    <div
      className={`w-full flex items-center justify-between p-4 rounded-lg transition-all duration-200 ${colorClasses[color]} ${priorityRings[priority]} hover:shadow-lg transform hover:scale-105`}
    >
      {' '}
...
function QuickActions({ onStartWorkflow }) {
  ...
  return (
    <div className="space-y-6">
      {' '}
      {/* Primary Actions */}{' '}
      <div className="@container bg-white rounded-2xl shadow-lg border border-gray-200/50 p-6 backdrop-blur-sm relative overflow-hidden">
        {' '}
        {/* Gradient overlay */}{' '}
