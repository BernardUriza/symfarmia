            ...
            <div className="group perspective-1000">
              <div className="transform transition-smooth hover:scale-105">
                ...
                <p className="text-foreground/60 mt-1 @sm:text-sm @md:text-base">
                  {t('efficient_clinical_management') ||
                    'Sistema de gestión clínica eficiente'}
                </p>
              </div>
            </div>
          ...
          <>
            ...
            <div className="grid @lg:grid-cols-3 @xl:grid-cols-4 gap-6">
              ...
              <div className="@lg:col-span-2 @xl:col-span-3 space-y-6">
                ...
                >
                  <div
                    className="stat-card glass hover:shadow-glow 
                  ...
                  >
                    ...
                    <div
                      className="absolute inset-0 bg-gradient-to-r from-transparent via-primary/5 to-transparent
                                    ...
                                    transition-transform duration-[2s] ease-out pointer-events-none"
                    ></div>
                    <div className="flex items-center justify-between mb-4 relative z-10">
                      <div className="flex items-center space-x-3">
                        <div
                          className="p-3 bg-gradient-to-br from-secondary/20 to-accent/20 
                        ...
                        <div>
                          ...
                          <p className="text-sm text-foreground/60">
                            {t('operational_metrics_description') ||
                              'Estado operacional y alertas críticas del sistema médico'}
                          </p>
                        </div>
                      </div>
