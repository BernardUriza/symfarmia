...
const MedicalFormExample = () => {
  ...
  const validateField = (name, value) => {
    switch (name) {
      ...
      case 'phone':
        return !/^\d{10}$/.test(value.replace(/\D/g, '')) ? 'Teléfono debe tener 10 dígitos' : '';
      case 'heartRate':
        const hr = parseInt(value);
        return (hr < 40 || hr > 200) ? 'Frecuencia cardíaca fuera de rango normal' : '';
      default:
  ...
  const getFieldClasses = (fieldName) => {
    ...
    return `
      ...
      ${hasError 
        ? 'border-red-500 dark:border-red-500 focus:border-red-500 dark:focus:border-red-500 focus:ring-4 focus:ring-red-500/20 dark:focus:ring-red-500/20' 
        : isValid
        ? 'border-green-500 dark:border-green-500 focus:border-green-500 dark:focus:border-green-500 focus:ring-4 focus:ring-green-500/20 dark:focus:ring-green-500/20'
        : 'border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500 focus:border-medical-primary dark:focus:border-medical-accent focus:ring-4 focus:ring-medical-primary/20 dark:focus:ring-medical-accent/20'
      }
    `;
  };
              ...
              <div className="group">
                ...
                {touched.patientName && errors.patientName && (
                  <p className="mt-1 text-sm text-red-600 dark:text-red-400 flex items-center
                                ...
                                translate-y-0 @starting-style:-translate-y-2
                                transition-all duration-300">
                    <AlertCircle className="h-4 w-4 mr-1" />
                    {errors.patientName}
                  </p>
                )}
                {touched.patientName && !errors.patientName && formData.patientName && (
