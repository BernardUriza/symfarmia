...
const LandingPageContent = () => {
  ...
  return (
    ...
    <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">¡Bienvenido a SYMFARMIA!</h3>
    <p className="text-gray-700 dark:text-gray-300 text-lg">
          ...
          {!isDemoMode && (
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                ...
                className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white font-semibold py-3 px-8 rounded-lg transition duration-200 shadow-lg hover:shadow-xl"
              >
                Login
              </a>
              <a
                href="/api/auth/login?returnTo=/legacy"
                className="bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white font-semibold py-3 px-8 rounded-lg transition duration-200 shadow-lg hover:shadow-xl"
              >
                Register
              </a>
              <button
                onClick={handleDemoClick}
                className="bg-gray-100 hover:bg-gray-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-gray-700 dark:text-gray-300 font-semibold py-3 px-8 rounded-lg transition duration-200 border-2 border-gray-300 dark:border-gray-600 inline-block"
              >
                Try Demo Mode
              </button>
            </div>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div
              ...
              className={`p-6 bg-white dark:bg-slate-800 rounded-lg shadow-md cursor-pointer transition-all duration-200 hover:shadow-lg ${isDemoMode ? 'animate-pulse border-2 border-blue-200 dark:border-blue-400' : ''}`}
            >
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Patient Management</h3>
              <p className="text-gray-600 dark:text-gray-300">Complete patient profiles and medical history tracking</p>
              {isDemoMode && (
            ...
            <div className={`p-6 bg-white dark:bg-slate-800 rounded-lg shadow-md cursor-pointer transition-all duration-200 hover:shadow-lg ${isDemoMode ? 'animate-pulse border-2 border-green-200 dark:border-green-400' : ''}`}>
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Medical Reports</h3>
              <p className="text-gray-600 dark:text-gray-300">Digital diagnosis tracking and documentation</p>
            </div>
            ...
            <div className={`p-6 bg-white dark:bg-slate-800 rounded-lg shadow-md cursor-pointer transition-all duration-200 hover:shadow-lg ${isDemoMode ? 'animate-pulse border-2 border-purple-200 dark:border-purple-400' : ''}`}>
              ...
              <p className="text-gray-600 dark:text-gray-300">Intelligent insights for medical practice</p>
            </div>
          </div>
        </div>
      </main>
