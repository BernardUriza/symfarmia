  ...
  return (
    <html lang="es" suppressHydrationWarning className="h-full">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: MedicalThemeScript }} />
      ...
      <body
        className="h-full font-sans bg-gradient-to-br from-background to-gray-100 text-foreground antialiased"
                    ...
                    <I18nServerProvider>
                      <PatientContextProvider>
                        <AppModeProvider>
                          ...
                          {/* MEDICAL MONITORING SCRIPT */}
                          <MedicalErrorBoundary context="Medical Monitoring" medicalWorkflow="System Health Check">
                            <MedicalMonitoringScript />
                          </MedicalErrorBoundary>
                        </AppModeProvider>
                      </PatientContextProvider>
